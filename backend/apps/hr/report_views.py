...
from apps.hr.reports import build_hr_reports
...
class HRReportsView(APIView):
    ...
    def get_permissions(self):
        ...
        perms.append(RequiresFeature("hr_reports")())
        return perms
    ...
    def get(self, request):
        ...
        report_type = request.query_params.get("type", "leaves")
